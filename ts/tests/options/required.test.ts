      ...
      const toPass = makeFx(
        (b, m) =>
          b
            ...
            .field(m.virtual('virtualField').validate(validator)),
        {
      ...
      const toFail = makeFx(
        (b, m) =>
          b
            ...
            .field(
              m.virtual('virtualField').alias('vAlias').validate(validator),
            ),
        {
      ...
      >(
        (b, m) =>
          b
            ...
            .field(m.virtual('setX').alias('y2').validate(validator)),
        {
          required: {
            fields: ['name', 'setX'],
            handler: () =>
