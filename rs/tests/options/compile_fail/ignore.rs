...
mod ignore_invalid_field {
    ...
    #[ignore(["lax", "invalid_field"], |_ctx, _opts| false)]
    const _: () = ();
}
...
mod ignore_constant {
    ...
    #[ignore(["lax", "id"], |_ctx, _opts| false)]
    const _: () = ();
}
...
mod ignore_dependent {
    ...
    #[ignore(["lax", "lax_1", "dependent"], |_ctx, _opts| false)]
    const _: () = ();
}

// should_reject_if_a_required_field_is_provided_to_the_fields_array
#[ivo_schema(
    input(DataInput, derive(Debug, Clone, PartialEq)),
    output(Data, derive(Debug, Clone, PartialEq))
)]
mod ignore_required {
    ...
    #[ignore(["lax", "required", "lax_1"], |_ctx, _opts| false)]
    const _: () = ();
}
...
mod ignore_alias_similar_to_dependent {
    struct Fields {
        #[lax(1234)]
        pub lax: i32,
...
mod ignore_alias_foreign_name {
    ...
    #[ignore(["lax", "lax_1", "alias"], |_ctx, _opts| false)]
    const _: () = ();
}
...
mod ignore_created_at_default {
    ...
    #[ignore(["lax", "lax_1", "created_at"], |_ctx, _opts| false)]
    const _: () = ();
}
...
mod ignore_created_at_custom {
    ...
    #[ignore(["lax", "lax_1", "custom_created_at"], |_ctx, _opts| false)]
    const _: () = ();
}
...
mod ignore_updated_at_default {
    ...
    #[ignore(["lax", "lax_1", "updated_at"], |_ctx, _opts| false)]
    const _: () = ();
}
...
mod ignore_updated_at_custom {
    ...
    #[ignore(["lax", "lax_1", "custom_updated_at"], |_ctx, _opts| false)]
    const _: () = ();
}
