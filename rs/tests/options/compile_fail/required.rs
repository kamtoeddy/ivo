...
mod required_invalid_field {
    ...
    #[required(["lax", "invalid_field"], |_, _| None)]
    const _: () = ();
}
...
mod required_dependent {
    ...
    #[required(["lax", "lax_1", "dependent"], |_, _| None)]
    const _: () = ();
}
...
mod required_required {
    ...
    #[required(["lax", "required", "lax_1"], |_, _| None)]
    const _: () = ();
}
...
mod required_alias_similar_to_dependent {
    struct Fields {
        #[lax(1234)]
        pub lax: i32,
...
mod required_alias_foreign_name {
    struct Fields {
        #[lax(1234)]
        pub lax: i32,
    ...
    #[required(["lax", "lax_1", "alias"], |_, _| None)]
    const _: () = ();
}
...
mod required_created_at_default {
    struct Fields {
        #[lax(1234)]
        pub lax: i32,
    ...
    #[required(["lax", "lax_1", "created_at"], |_, _| None)]
    const _: () = ();
}
...
mod required_created_at_custom {
    struct Fields {
        #[lax(1234)]
        pub lax: i32,
    ...
    #[required(["lax", "lax_1", "custom_created_at"], |_, _| None)]
    const _: () = ();
}
...
mod required_updated_at_default {
    struct Fields {
        #[lax(1234)]
        pub lax: i32,
    ...
    #[required(["lax", "lax_1", "updated_at"], |_, _| None)]
    const _: () = ();
}
...
mod required_updated_at_custom {
    struct Fields {
        #[lax(1234)]
        pub lax: i32,
    ...
    #[required(["lax", "lax_1", "custom_updated_at"], |_, _| None)]
    const _: () = ();
}
