...
pub static DATA_MODEL_WITH_VALIDATOR: LazyLock<Model<DataInput, Data>> = LazyLock::new(|| {
    Model::new(
        |f| {
            f.field(
                "dependent",
...
pub static DATA_MODEL_WITH_RE_VALIDATOR: LazyLock<Model<DataInput, Data>> = LazyLock::new(|| {
    Model::new(
        |f| {
            f.field(
                "dependent",
