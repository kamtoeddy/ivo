...
| `#[ignore]`                     | `#[lax]`, `#[ivo_virtual]`                | bare or `\|ctx, opts\| -> bool`                           | Bare `#[ignore]` always skips the field; `#[ignore(...)]` skips during create and update when the resolver returns `true`.                                        |
| `#[ignore_init]`                | `#[lax]`, `#[ivo_virtual]`                | none                                                      | Ignore field during create only.                                                                                                                                  |
| `#[ignore_update]`              | `#[required]`, `#[lax]`, `#[ivo_virtual]` | bare or `\|partial_input, full_output, rw_opts\| -> bool` | Bare `#[ignore_update]` always skips the field during update; the resolver form skips when it returns `true`.                                                     |
...
| `#[ignore_update([...], \|partial, full, opts\| ...)]`        | 0 or ≥2      | `#[required]`, `#[lax]`, `#[ivo_virtual]`                                       | Skip fields during update only; empty array means global update-ignore switch.                                                                                                                                                                                                                                                                                                                                                        |
