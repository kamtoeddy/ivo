...
async fn smoke_model_on_failure_trigger() {
    ...
    let errors = user_on_failure_schema::UserModel
        .create(input, ())
        .await
        .unwrap_err();
    assert!(errors.errors.contains_key("name"));
...
async fn smoke_model_post_validate_pass() {
    ...
    let created = user_post_validate_pass_schema::UserModel
        .create(input, ())
        .await
        .unwrap();
...
async fn smoke_model_post_validate_fail() {
    ...
    let errors = user_post_validate_fail_schema::UserModel
        .create(input, ())
        .await
        .unwrap_err();
...
async fn smoke_model_post_validate_pre_validate() {
    ...
    let created = user_post_validate_pre_schema::UserModel
        .create(input, ())
        .await
        .unwrap();
...
async fn smoke_model_post_validate_update_fail() {
    ...
    let errors = user_post_validate_update_fail_schema::UserModel
        .update(existing, updates, ())
        .await
        .unwrap_err();
...
async fn smoke_model_post_validate_update_update() {
    ...
    updates.set_b("old_b".to_string());
    let updated = user_post_validate_update_update_schema::UserModel
        .update(existing, updates, ())
        .await
        .unwrap();
