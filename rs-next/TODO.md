...
- [x] Port `examples/lax_defaults.rs`, `examples/lax_with_validators.rs`, and `examples/lax_readonly.rs` to the `#[ivo_schema]` macro API and verify assertions / example output.
