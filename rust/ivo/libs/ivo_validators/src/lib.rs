...
type StringValidatorError = (String, Option<StringValidatorOptions>);

pub fn make_string_validator(
    options: StringValidatorOptions,
) -> ValidatorFn<String, StringValidatorError> {
...
pub fn validate_email(value: String) -> ValidatorResponse<String, StringValidatorError> {
