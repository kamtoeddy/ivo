...
- **[`GOAL.md` §19](https://github.com/kamtoeddy/ivo/blob/main/rs-next/GOAL.md#19-schema-options-reference)** —
  the full reference table (minimum field counts, which field types each option accepts).
