...
| Property     | Type                         | Description                                                                                                                                                                                                                    |
| ------------ | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| allow        | any[]                        | used to specify the values that should be accepted for a property. It can be used without a validator but if a validator is provided, the values would first be checked against this list before being passed to the validator |
...
```ts
import type { Context, Summary, ValidationErrorMessage } from 'ivo'
